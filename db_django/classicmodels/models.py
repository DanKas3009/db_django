...
class CustomerServiceKpi(models.Model):
    customer_service_kpi_timestamp = models.DateTimeField(db_column='customer_service_KPI_timestamp', primary_key=True)  # Field name made lowercase.
    customer_service_kpi_average_waiting_time_minutes = models.IntegerField(db_column='customer_service_KPI_average_waiting_time_minutes')  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'customer_service_kpi'
