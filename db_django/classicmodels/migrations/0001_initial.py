...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('customer_service_kpi_timestamp', models.DateTimeField(db_column='customer_service_KPI_timestamp', primary_key=True, serialize=False)),
                ('customer_service_kpi_average_waiting_time_minutes', models.IntegerField(db_column='customer_service_KPI_average_waiting_time_minutes')),
            ],
            options={
